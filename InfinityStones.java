...
public class InfinityStones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView StoneName = (TextView) findViewById(R.id.t3);
        final TextView Congrats = (TextView) findViewById(R.id.t1);
        Button Stone = (Button) findViewById(R.id.GetStone);
